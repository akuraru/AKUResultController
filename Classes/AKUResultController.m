...
@interface AKUResultControllerSectionInfo : NSObject <NSFetchedResultsSectionInfo>
...
- (id<NSFetchedResultsSectionInfo>)createSectionInfo:(NSString *)name objects:(NSArray *)objects {
    AKUResultControllerSectionInfo *info = [[AKUResultControllerSectionInfo alloc] init];
    info.name = name;
...
- (void)createArrayIndexPath:(NSArray *)result {
    ...
    [result enumerateObjectsUsingBlock:^(AKUResultControllerSectionInfo *info, NSUInteger idx, BOOL *stop) {
...
@implementation AKUResultControllerSectionInfo
